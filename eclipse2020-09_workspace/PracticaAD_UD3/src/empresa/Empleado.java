...
public class Empleado implements java.io.Serializable {
	...
	public Empleado(int id, String dni, String nombre, String apellidos, int telefono) {
		this.id = id;
		this.dni = dni;
		this.nombre = nombre;
	...
	public Empleado(int id, String dni, String nombre, String apellidos, int telefono, Set empleadoProyectos,
			Set empleadoTareas) {
		this.id = id;
		this.dni = dni;
		this.nombre = nombre;
